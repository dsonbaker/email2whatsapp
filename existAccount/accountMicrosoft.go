...
func AccountMicrosoft(email string) {
	...
	if ResponseData.IfExistsResult == 0 {
		fmt.Println("\033[32m[+] This account exists on Microsoft \033[0m")
	}
